...
- 파라미터를 적절히 전달해서 jsp 페이지 내에서 해당 파라미터를
  추출하여 어떤 로직을 수행할 수 있다.
- 아래 같은 경우는 thisPage라는 파라미터 명으로 member 라는
  문자열을 전달한다.
  이는 navbar.jsp?thisPage=member와 유사한 작동을 하며
  navbar.jsp 페이지 내부에서
  
  String thisPage=request.getParameter("thisPage");
  
  코드를 수행하면 thisPage 객체 안에는 
  member라는 문자열이 들어있게 된다.
 --%>
